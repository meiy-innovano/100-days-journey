...
export default class Resources extends EventEmitter {
    constructor() {
        ...
        this.loader.load([
            ...
            { name: 'projectsLuniFloor', source: './models/projects/luni/floorTexture.png', type: 'texture' },
            { name: 'projectsBonhomme10ansFloor', source: './models/projects/bonhomme10ans/floorTexture.png', type: 'texture' },
            { name: 'projectsThreejsJourneyFloor', source: './models/projects/threejsJourney/floorTexture.png', type: 'texture' },
