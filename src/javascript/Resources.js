...
export default class Resources extends EventEmitter {
    constructor() {
        ...
        this.loader.load([
            ...
            // Font
            { name: 'font', source: './fonts/helvetiker_bold.typeface.json' },
            ...
            { name: 'projectsThreejsJourneyFloor', source: './models/projects/theme1/floorTexture.png', type: 'texture' },
            { name: 'projectsChartogneFloor', source: './models/projects/theme2/floorTexture.png', type: 'texture' },
            { name: 'projectsBonhomme10ansFloor', source: './models/projects/theme3/floorTexture.png', type: 'texture' },
            { name: 'projectsLuniFloor', source: './models/projects/theme4/floorTexture.png', type: 'texture' },
            { name: 'projectsMadboxFloor', source: './models/projects/theme5/floorTexture.png', type: 'texture' },
            { name: 'projectsScoutFloor', source: './models/projects/theme6/floorTexture.png', type: 'texture' },
            { name: 'projectsPriorHoldingsFloor', source: './models/projects/theme7/floorTexture.png', type: 'texture' },
            { name: 'projectsOranoFloor', source: './models/projects/theme8/floorTexture.png', type: 'texture' },
            { name: 'projectsCitrixRedbullFloor', source: './models/projects/theme9/floorTexture.png', type: 'texture' },
            { name: 'projectsGleecChatFloor', source: './models/projects/theme10/floorTexture.png', type: 'texture' },
            ...
            { name: 'informationActivities', source: './models/information/floorTexture.png', type: 'texture' },
